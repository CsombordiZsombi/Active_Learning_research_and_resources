# Source: https://github.com/orico/ActiveLearningFrameworkTutorial/blob/master/Active_Learning_Tutorial.ipynb
...
max_queried = 100 #originaly = 500

trainset_size = 1700  # ie., testset_size = 10000 originaly = 60000

def download():
    mnist = load_digits() #fetch_openml('mnist_784')
